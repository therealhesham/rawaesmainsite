...
const contactLinks = [
  { label: "الإدارة القانونية", href: "#" },
  { label: "الإدارة العليا", href: "#" },
  { label: "للاقتراحات والمساعدة", href: "#" },
];
      ...
      <div className="flex flex-wrap gap-4">
        {contactLinks.map((item) => (
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-white font-medium hover:opacity-90 transition-opacity"
