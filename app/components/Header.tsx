...
export function Header() {
  ...
  const navItems = [
    ...
    { label: "نبذه عنا", href: "#about" },
    { label: "قطاعاتنا", href: "#sectors", icon: "expand_more" },
    { label: "استثمر معنا", href: "/invest", icon: "expand_more" },
              ...
              {navItems.map((item, i) => (
                ...
                >
                  <Link
                    ...
                    className={`flex items-center justify-between px-4 py-3 rounded-xl text-[0.95rem] font-semibold transition-all duration-200 ${item.active
